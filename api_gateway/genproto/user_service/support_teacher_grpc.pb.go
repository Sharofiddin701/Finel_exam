...
type SupportTeacherServiceClient interface {
	...
	Delete(ctx context.Context, in *SupportTeacherPrimaryKey, opts ...grpc.CallOption) (*SupportTeacherEmpty, error)
}
...
func (c *supportTeacherServiceClient) Delete(ctx context.Context, in *SupportTeacherPrimaryKey, opts ...grpc.CallOption) (*SupportTeacherEmpty, error) {
...
type SupportTeacherServiceServer interface {
	...
	Delete(context.Context, *SupportTeacherPrimaryKey) (*SupportTeacherEmpty, error)
...
func (UnimplementedSupportTeacherServiceServer) Delete(context.Context, *SupportTeacherPrimaryKey) (*SupportTeacherEmpty, error) {
