...
type ManagerServiceClient interface {
	...
	Delete(ctx context.Context, in *ManagerPrimaryKey, opts ...grpc.CallOption) (*ManagerEmpty, error)
}
...
func (c *managerServiceClient) Delete(ctx context.Context, in *ManagerPrimaryKey, opts ...grpc.CallOption) (*ManagerEmpty, error) {
...
type ManagerServiceServer interface {
	...
	Delete(context.Context, *ManagerPrimaryKey) (*ManagerEmpty, error)
...
func (UnimplementedManagerServiceServer) Delete(context.Context, *ManagerPrimaryKey) (*ManagerEmpty, error) {
