...
func SetUpServer(cfg config.Config, log logger.LoggerI, strg storage.StorageI, srvc client.ServiceManagerI) (grpcServer *grpc.Server) {
	...
	user_service.RegisterSuperAdminServiceServer(grpcServer, service.NewSuperAdminService(cfg, log, strg, srvc))
	...
	user_service.RegisterAdministratorServiceServer(grpcServer, service.NewAdministratorService(cfg, log, strg, srvc))
