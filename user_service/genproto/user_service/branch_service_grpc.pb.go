...
const (
	BranchService_Create_FullMethodName  = "/user_service.BranchService/Create"
	BranchService_GetByID_FullMethodName = "/user_service.BranchService/GetByID"
	BranchService_GetList_FullMethodName = "/user_service.BranchService/GetList"
	BranchService_Update_FullMethodName  = "/user_service.BranchService/Update"
	BranchService_Delete_FullMethodName  = "/user_service.BranchService/Delete"
)
...
func (c *branchServiceClient) GetByID(ctx context.Context, in *BranchPrimaryKey, opts ...grpc.CallOption) (*Branch, error) {
	out := new(Branch)
	err := c.cc.Invoke(ctx, BranchService_GetByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *branchServiceClient) GetList(ctx context.Context, in *GetListBranchRequest, opts ...grpc.CallOption) (*GetListBranchResponse, error) {
	...
	err := c.cc.Invoke(ctx, BranchService_GetList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BranchService_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BranchService_GetList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
